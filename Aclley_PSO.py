...
# Параметры PSO
num_particles = 15  # Количество частиц
num_iterations = 50  # Количество итераций
w = 0.5  # Коэффициент инерции
c1 = 1.5  # Коэффициент обучения для личного лучшего
c2 = 1.5  # Коэффициент обучения для глобального лучшего
...
# Итоговые результаты
print("\nГлобальный минимум:")
print(f"Положение: {global_best_position}")
print(f"Значение функции: {global_best_value:.5f}")
